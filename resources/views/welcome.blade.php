...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class=" max-w-6xl mx-auto sm:px-6 lg:px-8 justify-center pt-8 sm:justify-start sm:pt-0">
                <center>
                    <span class="  py-2 px-2 font-semibold  text-gray-200 text-lg dark:text-white judul"> PMB UNIWA</span>
                </center>
                <center>
                    @if (Route::has('login'))
                    <div class="">
